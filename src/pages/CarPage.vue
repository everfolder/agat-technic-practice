...
<template>
  <div class="container car-page">
    <div class="car-page__head">
      ...
      <button class="car-page__check-price" data-fancybox data-src="#check-price">
        Узнать цену
      </button>
      <Modal id="check-price" title="Узнать цену">
        <Form id="check-price__form"></Form>
      </Modal>
    </div>
    <div class="car-page__main-info">
      <div class="car-page__main-info-image">
        <img :src="car.preview_picture.path" alt="">
      </div>
    ...
    <div class="car-page__properties">
      <div class="car-page__properties-container">
        ...
        <div class="car-page__properties-data">
          ...
          <CarPagePropertyItem parameter="Мощность двигателя л.с. при об/мин"
            :value="car.propertyValues.engine_power" />
