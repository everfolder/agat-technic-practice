...
<template>
  <div class="admin">
    <div class="admin__navigation">
      <button class="admin__open-panel" @click="setActivePanel('catalog')">Панель каталога</button>
      <button class="admin__open-panel" @click="setActivePanel('news')">Панель новостей</button>
